...
function timer() {
    ...
    if (answer === 5) {
        ...
        if(isNaN(answer)){//בדיקה האם נכתב מספר?
            ...
            alert("❌You didn't succeed, it's okay🙃. You have 1.5 more minutes to find all of Moti's pictures and then you can continue solving the riddels.");//הודעה לנסיון שני
            tries += 1;
            setTimeout(timer2, 90000);
        }
    }
}
    function timer2() {
